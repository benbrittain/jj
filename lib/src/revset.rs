...
fn fold_heads_range<St: ExpressionState>(
    ...
    struct FilteredRange<St: ExpressionState> {
        ...
        heads: Option<Arc<RevsetExpression<St>>>,
...
impl RevsetExtensions {
    ...
    pub fn add_symbol_resolver(&mut self, symbol_resolver: Arc<dyn SymbolResolverExtension>) {
...
impl<'a> LoweringContext<'a> {
    ...
    pub fn symbol_resolvers(&self) -> &'a [Arc<dyn SymbolResolverExtension>] {
